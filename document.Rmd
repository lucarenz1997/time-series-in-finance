...
The last analysis investigated the impact of changes in coal-based U.S. electricity generation on coal futures returns. The VAR model for this section fits Coal futures returns and Coal U.S energy generation data, variables Coal_Futures_Returns and Coal_US_Electricity_Generation, at lag = 15: 
